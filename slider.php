    ...
    <div class="carousel-inner">
	  ...
	  <div class="item">
        ...
        <div class="carousel-caption" style="opacity: 1.1;">
         <?php /*<h3 style="color: #d8a71b;"  >VEC HOSTEL..</h3>
          <b style="color: #d8a71b;"  >VEC HOSTEL...</b>*/?>
        </div>
      </div>
      ...
      <div class="item active">
        ...
        <div class="carousel-caption" style="opacity: 1.1;">
          <h3 style="color: black;" >VEC HOSTEL..</h3>
      ...
      <div class="item">
        ...
        <div class="carousel-caption" style="opacity: 1.1;">
          <h3 style="color: #d8a71b;"  >VEC HOSTEL..</h3>
          <b style="color: #d8a71b;"  >...</b>
        </div>
      </div>
