...
<div class="form-group">
	...
	<form action="/action_page.php">
  		<input type="checkbox" id="pll" name="pll" value="proofofleaveletter">
  			<label for="pll"> proof of Leave letter</label><br>
  		<input type="checkbox" id="od" name="od" value="odletter">
  			<label for="od"> OD letter</label><br>
  		<input type="checkbox" id="outpass" name="outpass" value="outpass">
  			<label for="outpass"> OutPass</label><br>
		<input type="checkbox" id="staypass" name="staypass" value="staypass">
			<label for="staypass" >STAY PASS</label><br>  		
	</form>
	</div>
	<div class="form-group">
		<label>
	...
	<div class="form-group">
		...
		<input class="form-control" type="text" placeholder="guardiannumber" name="guardiannumber" value="<?php echo $rsedit['guardiannumber'];?>">
	</div>
